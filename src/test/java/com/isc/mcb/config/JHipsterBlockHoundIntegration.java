...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.isc.mcb.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.isc.mcb.security.DomainUserDetailsService", "createSpringSecurityUser");
